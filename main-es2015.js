...
let DanhMucComponent = class DanhMucComponent {
...
let ExamDetailComponent = class ExamDetailComponent {
    constructor(route, quizService, location, subjectService) {
        this.route = route;
...
ExamDetailComponent.ctorParameters = () => [
...
let ChangeInfComponent = class ChangeInfComponent {
    constructor() { }
    ngOnInit() {
    }
};
